...
public class ProductInfoAction {
    ...
    public Object ajaxImg(MultipartFile pimage,HttpServletRequest request){
        ...
        //返回客户端json对象，封装图片的路径，为了在界面实现立即回显
    ...
    public String save(ProductInfo info,HttpServletRequest request){
        ...
        //info对象中有表单提交上来的5个数据，有异步ajax上来的图片名称和上架时期
        int num=-1;
        try {
        ...
        //清空变量saveFileName中的内容，为了下次增加或修改异步ajax的上传处理
        saveFileName="";
        //增加成功后应该重新访问数据库，所以跳到分页显示的action上
    ...
    public String one(Integer pid, ProductInfoVo vo, Model model,HttpSession session){
        ...
        //将多条件及页码放入session中，更新处理结束后分页时去读条件和页码进行处理
    ...
    public String update(ProductInfo info,HttpServletRequest request){
        //因为ajax的图片上传，如果有上传过，则saveFileName里面有上传的图片名称，
        //如果没有使用异步ajax上传过图片则saveFileName="";
        //那么实体类info使用隐藏表单提供上来的pImage原始图片名称
        ...
        //处理完更新后saveFileName里可能会有数据
        //会影响下次的更新操作，这时要再次清空saveFileName
        saveFileName ="";
